...
void GuiKeyMappingEditor::initMappingNames()
{
	mMappingNames =
	{
		...
		{ "x",               "X",   ":/help/buttons_west.svg" },
		{ "y",               "Y",    ":/help/buttons_north.svg" },
		...
		{ "hotkey + x",       "HOTKEY + X",    ":/help/button_hotkey.svg", ":/help/buttons_west.svg" },
		{ "hotkey + y",       "HOTKEY + Y",   ":/help/button_hotkey.svg", ":/help/buttons_north.svg" }
	};
}
