	...
	mSavedCallback(saveCallback), mDeleteFunc(deleteFunc)
{
	...
	if(mDeleteFunc)
	{
		...
		auto deleteBtnFunc = [this, deleteFileAndSelf] { mWindow->pushGui(new GuiMsgBox(mWindow, _("ISTO EXCLUIRÁ O(S) ARQUIVO(S) DO JOGO!\nVOCÊ TEM CERTEZA?"), _("YES"), deleteFileAndSelf, _("NO"), nullptr)); };
